...
module.exports = {
  ...
  description:
    'Compare a plaintext password attempt against a Bcrypt hash (i.e. already-encrypted).',
  ...
  inputs: {
    ...
    hashedPassword: {
      ...
      whereToGet: {
        description:
          'Look up the password hash stored for this user from your database.',
        extendedDescription:
          'For example, when a user signs up, your route could use the "Hash password" machine ' +
